...
1. Monte-Carlo journalier proportions alcool/nuit par type (3×2 = 6) ; agrégation hebdomadaire. **Contrainte 60%** : En moyenne **60% des valeurs supérieures à 0 n'auront ni alcool, ni nuit** (modifier caractéristique aléatoire pour arriver environ à ce résultat). **Régimes appliqués** : Les phénomènes (crise, dégradé, normal) sont appliqués aux variables alcool/nuit (même probabilités : 80% normal, 15% dégradé, 5% crise).
...
- [ ] Implémenter contrainte 60% sans alcool ni nuit (modifier caractéristique aléatoire)
- [ ] Implémenter application régimes aux variables alcool/nuit (80% normal, 15% dégradé, 5% crise)
...
- [ ] Tests : proportions [0,1], contrainte 60% sans alcool ni nuit, régimes appliqués, patterns, modification matrices
...
| 28 Jan 2026 | 1.1 | Ajout contrainte 60% sans alcool ni nuit et application régimes aux variables alcool/nuit | PM |
